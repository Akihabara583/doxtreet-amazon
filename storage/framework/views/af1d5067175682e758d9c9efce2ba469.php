<?php $__env->startSection('title', __('messages.sign_document') . ' - ' . config('app.name')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <form id="sign-form" action="<?php echo e(route('sign.upload', ['locale' => app()->getLocale()])); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card shadow-sm">
                        <div class="card-header bg-light py-3">
                            <h1 class="h4 mb-0"><?php echo e(__('messages.sign_document')); ?></h1>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <h5>1. <?php echo e(__('messages.upload_document')); ?></h5>
                                    <div class="mb-3">
                                        <label for="document" class="form-label"><?php echo e(__('messages.select_pdf_file')); ?></label>
                                        <input class="form-control" type="file" id="document" name="document" accept="application/pdf" required>
                                    </div>

                                    <div id="preview-container" style="display: none;">
                                        <p class="fw-bold"><?php echo e(__('messages.click_or_drag_to_place_signature')); ?></p>
                                ...
                                <div class="col-md-5">
                                    <h5>2. <?php echo e(__('messages.place_your_signature_here')); ?></h5>
                                    <div class="signature-wrapper">
                                        <p class="text-muted small mb-2"><?php echo e(__('messages.draw_in_this_box')); ?></p>
                                        <canvas id="signature-pad" width="400" height="200"></canvas>
                                        <div class="controls">
                                            <button type="button" id="clear-signature" class="btn btn-sm btn-outline-secondary"><?php echo e(__('messages.clear')); ?></button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-check mt-3">
                                        ...
                                        <label class="form-check-label" for="save_signature">
                                            <?php echo e(__('messages.save_signature_to_profile')); ?>
                            ...
                            <div class="d-grid">
                                <button type="submit" id="submit-button" class="btn btn-primary btn-lg"><?php echo e(__('messages.sign_and_download')); ?></button>
                            </div>
                        </div>
                    </div>
                </form>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            placementMarker.innerHTML = `<span><?php echo e(__('messages.signature_placement')); ?></span>`;
            ...
            form.addEventListener('submit', function (event) {
                if (signaturePad.isEmpty()) {
                    ...
                    errorContainer.innerHTML = `<div class="alert alert-danger"><?php echo e(__('messages.please_provide_a_signature')); ?></div>`;
                    window.scrollTo(0, 0);
                } else {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/1507933.cloudwaysapps.com/nkpgfkrnfq/public_html/resources/views/sign/index.blade.php ENDPATH**/ ?>