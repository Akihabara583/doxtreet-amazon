<?php $__env->startSection('title', __('messages.blog') . ' - ' . config('app.name')); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="modern-section">
        <div class="container">
            <h1 class="modern-section-title mb-5"><?php echo e(__('messages.our_blog')); ?></h1>
                            ...
                            <div class="modern-card shadow-sm h-100 d-flex flex-column">
                                ...
                                <div class="flex-grow-1">
                                    <h2 class="card-title h4">
                                        <a href="<?php echo e(route('posts.show', ['locale' => app()->getLocale(), 'slug' => $post->slug])); ?>" class="text-decoration-none text-primary fw-bold"><?php echo e($post->title); ?></a>
                                    </h2>
                                    <?php if($post->published_at): ?>
                                        <p class="text-muted small mb-3">
                                            <?php echo e(__('messages.published_on')); ?>: <?php echo e($post->published_at->format('d.m.Y')); ?>

                                        </p>
                                    <?php endif; ?>
                                    <p class="card-text text-secondary">
                                        <?php echo e(Str::limit(strip_tags($post->body), 200)); ?>

                                    </p>
                                </div>
                                
                                <a href="<?php echo e(route('posts.show', ['locale' => app()->getLocale(), 'slug' => $post->slug])); ?>" class="btn btn-outline-modern btn-sm mt-4"><?php echo e(__('messages.read_more')); ?> &rarr;</a>
                            </div>
                        </div>
            ...
            <?php else: ?>
                <div class="text-center py-5 col-lg-6 mx-auto">
                    ...
                    <h4 class="text-primary"><?php echo e(__('messages.no_articles_yet')); ?></h4>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/1507933.cloudwaysapps.com/nkpgfkrnfq/public_html/resources/views/posts/index.blade.php ENDPATH**/ ?>