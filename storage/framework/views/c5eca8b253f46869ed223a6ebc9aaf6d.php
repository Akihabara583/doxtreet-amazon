<?php if($showCookieConsentBanner ?? false): ?>
    ...
    <?php if($showCookieConsentOverlay ?? false): ?>
        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-lg-8 mb-3 mb-lg-0">
                    <h4 class="mb-2"><?php echo e(__('messages.cookie_title')); ?></h4>
                    <p class="mb-0 small">
                        <?php echo e(__('messages.cookie_text')); ?>

                        <a href="<?php echo e(route('privacy', app()->getLocale())); ?>"><?php echo e(__('messages.privacy_policy')); ?></a>.
                    </p>
                </div>
                <div class="col-lg-4 text-lg-end">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a href="<?php echo e(route('cookie.decline')); ?>" class="btn btn-modern btn-outline-modern px-4" id="cookie-decline-btn"><?php echo e(__('messages.decline')); ?></a>
                        <a href="<?php echo e(route('cookie.accept')); ?>" class="btn btn-modern btn-primary-modern px-4" id="cookie-accept-btn"><?php echo e(__('messages.accept')); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /home/1507933.cloudwaysapps.com/nkpgfkrnfq/public_html/resources/views/partials/cookie_consent_banner.blade.php ENDPATH**/ ?>