...
<?php endif; ?>
    ...
    <h2 class="text-center mb-4" style="font-weight: 700; color: var(--text-primary);"><?php echo e(__('messages.welcome_back')); ?></h2>
...
<?php endif; ?>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div class="form-check">
                ...
                <label class="form-check-label" for="remember_me"><?php echo e(__('messages.remember_me')); ?></label>
            </div>
            <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request', ['locale' => app()->getLocale()])); ?>"><?php echo e(__('messages.forgot_password')); ?></a>
            <?php endif; ?>
        </div>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('messages.log_in_button')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="text-center">
            <div class="d-flex align-items-center my-4">
                ...
                <span class="mx-2 text-muted small"><?php echo e(__('messages.or_continue_with')); ?></span>
                <hr class="flex-grow-1" style="border-color: var(--border);">
            </div>
            <a href="<?php echo e(route('social.redirect', ['provider' => 'google', 'locale' => app()->getLocale()])); ?>" class="btn btn-outline-secondary w-100">
        ...
        <p class="text-center mt-4 small">
            ...
            <a href="<?php echo e(route('register', ['locale' => app()->getLocale()])); ?>"><?php echo e(__('messages.sign_up_link')); ?></a>
        </p>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/1507933.cloudwaysapps.com/nkpgfkrnfq/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>