...
class PlEducationSeeder extends Seeder
{
    public function run(): void
    {
        $category = Category::where('slug', 'school-education-pl')->first();
        if (!$category) {
            $this->command->error('Category with slug "school-education-pl" not found.');
            return;
        }
        $templatesData = [
            // --- Заявление на академический отпуск / Application for Academic Leave ---
            [
                'slug' => 'academic-leave-application-pl',
        'access_level' => 'free',
                'fields' => '[
            ...
            [
                'slug' => 'transfer-specialization-application-pl',
        'access_level' => 'free',
                'fields' => '[
                    {"name":"city","type":"text","required":true,"labels":{"pl":"Miejscowość","en":"City","uk":"Місто","de":"Ort"}},
                    {"name":"applicant_full_name","type":"text","required":true,"labels":{"pl":"Imię i nazwisko studenta","en":"Student\'s Full Name","uk":"ПІБ студента","de":"Vollständiger Name des Studenten"}},
            ...
            [
                'slug' => 'transfer-university-application-pl',
        'access_level' => 'free',
                'fields' => '[
                    {"name":"city","type":"text","required":true,"labels":{"pl":"Miejscowość","en":"City","uk":"Місто","de":"Ort"}},
                    {"name":"applicant_full_name","type":"text","required":true,"labels":{"pl":"Imię i nazwisko studenta","en":"Student\'s Full Name","uk":"ПІБ студента","de":"Vollständiger Name des Studenten"}},
                ...
                'translations' => [
                    ...
                    'uk' => [
                        ...
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center;"><h1 style="font-size: 18px; font-weight: bold;">ЗАЯВА ПРО ПЕРЕВЕДЕННЯ В ІНШИЙ ВНЗ</h1></div><table width="100%" style="font-family: DejaVu Sans, sans-serif; font-size:12px;"><tr><td><p>[[applicant_full_name]]<br>Номер залікової книжки: [[student_id_number]]<br>Поточний ВНЗ: [[current_university_name]]</p></td><td style="text-align: right;"><p>[[city]], ' . date('d.m.Y') . ' р.</p></td></tr></table>',
                        'body_html' => '<div style="font-family: DejaVu Sans, sans-serif; font-size: 12px; line-height: 1.6; text-align: justify;">
        ...
        'access_level' => 'free',
                ...
                'translations' => [
                    ...
                    'de' => [
                        ...
                        'description' => 'Eine Vorlage zur Erstellung eines Plans für eine Diplomarbeit (Bachelor-/Master-/Ingenieurarbeit).',
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center;"><h1 style="font-size: 20px; font-weight: bold;">DIPLOMARBEITSPLAN</h1><p style="font-size: 14px;"><strong>[[university_name]]</strong><br>Fakultät [[faculty_name]]<br>Studiengang: [[field_of_study]]</p></div><table width="100%" style="font-family: DejaVu Sans, sans-serif; font-size:12px;"><tr><td><p>Student: [[student_full_name]]<br>Matrikelnummer: [[student_id_number]]</p></td><td style="text-align: right;"><p>Betreuer: [[supervisor_full_name]]</p></td></tr></table>',
                        'body_html' => '<div style="font-family: DejaVu Sans, sans-serif; font-size: 12px; line-height: 1.6;">
        ...
        'access_level' => 'free',
                ...
                'translations' => [
                    'pl' => [
                        ...
                        'footer_html' => '' // Usually empty for title pages
                    ],
                    'en' => [
        ...
        'access_level' => 'free',
                ...
                'translations' => [
                    'pl' => [
                        ...
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center; margin-top: 50px;">
                                ...
                                <p style="font-size: 12px;">Kierunek: [[field_of_study]]</p>
                                <br/><br/>
                                <h1 style="font-size: 24px; font-weight: bold;">PRACA ZALICZENIOWA/PROJEKTOWA</h1>
                                <h2 style="font-size: 20px; font-weight: bold;">[[coursework_title]]</h2>
                                <br/><br/>
                                <p style="font-size: 12px;">Autor: [[student_full_name]]</p>
                                <p style="font-size: 12px;">Nr albumu: [[student_id_number]]</p>
                                <br/>
                                <p style="font-size: 12px;">Promotor/Opiekun: [[supervisor_full_name]]</p>
                                <br/><br/><br/>
                            </div>',
                        'body_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center; font-size: 12px; line-height: 1.6;">
                                <p>[[city]], [[year]]</p>
                    ...
                    'uk' => [
                        ...
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center; margin-top: 50px;">
                                ...
                                <p style="font-size: 12px;">Напрямок: [[field_of_study]]</p>
                                <br/><br/>
                                <h1 style="font-size: 24px; font-weight: bold;">КУРСОВА РОБОТА/ПРОЕКТ</h1>
                                <h2 style="font-size: 20px; font-weight: bold;">[[coursework_title]]</h2>
                                <br/><br/>
                                <p style="font-size: 12px;">Автор: [[student_full_name]]</p>
                                <p style="font-size: 12px;">Номер залікової книжки: [[student_id_number]]</p>
            ...
            // --- Титульный лист для дипломной работы / Title Page for Diploma Thesis ---
            [
                'slug' => 'diploma-thesis-title-page-pl',
        'access_level' => 'free',
                'fields' => '[
                    {"name":"university_name","type":"text","required":true,"labels":{"pl":"Nazwa uczelni","en":"University Name","uk":"Назва ВНЗ","de":"Name der Universität"}},
                    {"name":"faculty_name","type":"text","required":true,"labels":{"pl":"Nazwa wydziału","en":"Faculty Name","uk":"Назва факультету","de":"Name der Fakultät"}},
                ...
                'translations' => [
                    'pl' => [
                        ...
                        'description' => 'Standardowy szablon strony tytułowej dla pracy dyplomowej (licencjackiej, inżynierskiej, magisterskiej).',
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center; margin-top: 50px;">
                                <p style="font-size: 14px; font-weight: bold;">[[university_name]]</p>
                                <p style="font-size: 12px;">Wydział [[faculty_name]]</p>
                                <p style="font-size: 12px;">Kierunek: [[field_of_study]]</p>
                    ...
                    'en' => [
                        'title' => 'Title Page for Diploma Thesis',
                        'description' => 'Standard title page template for a diploma thesis (bachelor\'s, engineering, master\'s).',
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center; margin-top: 50px;">
                                <p style="font-size: 14px; font-weight: bold;">[[university_name]]</p>
                                <p style="font-size: 12px;">Faculty of [[faculty_name]]</p>
                                <p style="font-size: 12px;">Field of Study: [[field_of_study]]</p>
                    ...
                    'uk' => [
                        ...
                        'description' => 'Стандартний шаблон титульного листа для дипломної роботи (бакалаврської, інженерної, магістерської).',
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center; margin-top: 50px;">
                                <p style="font-size: 14px; font-weight: bold;">[[university_name]]</p>
                                <p style="font-size: 12px;">Факультет [[faculty_name]]</p>
                                <p style="font-size: 12px;">Напрямок: [[field_of_study]]</p>
                    ...
                    'de' => [
                        'title' => 'Titelseite für die Abschlussarbeit',
                        'description' => 'Standardvorlage für die Titelseite einer Abschlussarbeit (Bachelor-, Ingenieur-, Masterarbeit).',
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center; margin-top: 50px;">
                                <p style="font-size: 14px; font-weight: bold;">[[university_name]]</p>
                                <p style="font-size: 12px;">Fakultät [[faculty_name]]</p>
                                <p style="font-size: 12px;">Studiengang: [[field_of_study]]</p>
            ...
            // --- Рецензия на научную работу / Review of Scientific Work ---
            [
                'slug' => 'scientific-work-review-pl',
        'access_level' => 'free',
                'fields' => '[
                    {"name":"city","type":"text","required":true,"labels":{"pl":"Miejscowość","en":"City","uk":"Місто","de":"Ort"}},
                    {"name":"review_date","type":"date","required":true,"labels":{"pl":"Data sporządzenia recenzji","en":"Review Date","uk":"Дата складання рецензії","de":"Datum der Rezension"}},
                    {"name":"reviewer_full_name","type":"text","required":true,"labels":{"pl":"Imię i nazwisko recenzenta","en":"Reviewer\'s Full Name","uk":"ПІБ рецензента","de":"Vollständiger Name des Rezensenten"}},
                    {"name":"reviewer_title_affiliation","type":"text","required":true,"labels":{"pl":"Tytuł naukowy/stanowisko i afiliacja recenzenta","en":"Reviewer\'s Title/Position and Affiliation","uk":"Науковий ступінь/посада та афіліація рецензента","de":"Akademischer Grad/Position und Zugehörigkeit des Rezensenten"}},
                ...
                'translations' => [
                    ...
                    'de' => [
                        'title' => 'Rezension einer wissenschaftlichen Arbeit',
                        'description' => 'Eine Vorlage zur Rezension einer wissenschaftlichen Arbeit, einschließlich inhaltlicher und formaler Bewertung.',
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center;"><h1 style="font-size: 20px; font-weight: bold;">REZENSION EINER WISSENSCHAFTLICHEN ARBEIT</h1></div><table width="100%" style="font-family: DejaVu Sans, sans-serif; font-size:12px;"><tr><td><p>Rezensent: <strong>[[reviewer_full_name]]</strong><br>[[reviewer_title_affiliation]]</p></td><td style="text-align: right;"><p>[[city]], den ' . date('d.m.Y') . '</p></td></tr></table>',
                        'body_html' => '<div style="font-family: DejaVu Sans, sans-serif; font-size: 12px; line-height: 1.6;">
                                <h2 style="font-size:16px; font-weight:bold; text-align: center; margin-top:20px;">Arbeitstitel: <br>[[work_title]]</h2>
                                <p style="text-align: center;">Autor: [[work_author_full_name]]</p>
                                <h2 style="font-size:14px; font-weight:bold; margin-top:20px;">1. INHALT DER REZENSION</h2>
                                <p>[[review_content]]</p>
                                <h2 style="font-size:14px; font-weight:bold; margin-top:20px;">2. ENDNOTE/EMPFEHLUNG</h2>
                                <p><strong>[[final_grade_recommendation]]</strong></p>
                            </div>',
                        'footer_html' => '<div style="font-family: DejaVu Sans, sans-serif; margin-top: 50px; font-size: 12px; text-align: center;">
                                <p>___________________<br>(Unterschrift des Rezensenten)</p>
                            </div>'
                    ]
                ]
            ],

            // --- Отзыв научного руководителя / Supervisor's Review ---
            [
                'slug' => 'supervisor-review-pl',
        'access_level' => 'free',
                'fields' => '[
                    {"name":"city","type":"text","required":true,"labels":{"pl":"Miejscowość","en":"City","uk":"Місто","de":"Ort"}},
                    {"name":"review_date","type":"date","required":true,"labels":{"pl":"Data sporządzenia opinii","en":"Review Date","uk":"Дата складання відгуку","de":"Datum der Stellungnahme"}},
            ...
            // --- Портфолио студента/ученика / Student/Pupil Portfolio ---
            [
                'slug' => 'student-portfolio-pl',
        'access_level' => 'free',
                'fields' => '[
                ...
                'translations' => [
                    'pl' => [
                        ...
                        'footer_html' => '' // Usually no footer for portfolios
                    ],
                    'en' => [
                    ...
                    'de' => [
                        ...
                        'description' => 'Eine Vorlage zur Erstellung eines Portfolios, das die Leistungen und Fähigkeiten eines Studenten/Schülers präsentiert.',
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; text-align: center; margin-top: 50px;">
                                <h1 style="font-size: 24px; font-weight: bold;">PORTFOLIO</h1>
                                <p style="font-size: 18px;">[[portfolio_owner_full_name]]</p>
                                <p style="font-size: 14px;">[[portfolio_owner_school_university]] - [[portfolio_owner_field_of_study_class]]</p>
                                <p style="font-size: 12px;">Erstellungsdatum: [[portfolio_date]]</p>
                            </div>',
                        'body_html' => '<div style="font-family: DejaVu Sans, sans-serif; font-size: 12px; line-height: 1.6;">
            ...
            // --- Мотивационное письмо для поступления в ВУЗ / Motivation Letter for University Admission ---
            [
                'slug' => 'university-motivation-letter-pl',
        'access_level' => 'free',
                'fields' => '[
                    {"name":"city","type":"text","required":true,"labels":{"pl":"Miejscowość","en":"City","uk":"Місто","de":"Ort"}},
                ...
                'translations' => [
                    'pl' => [
                        ...
                        'header_html' => '<div style="font-family: DejaVu Sans, sans-serif; font-size: 12px; line-height: 1.5;">
                                ...
                                <br/><br/>
                                <h1 style="font-size: 18px; font-weight: bold; text-align: center;">LIST MOTYWACYJNY</h1>
                                <p style="font-size: 14px; text-align: center;"><strong>Dotyczy:</strong> Rekrutacja na kierunek [[field_of_study]]</p>
                            </div>',
                        'body_html' => '<div style="font-family: DejaVu Sans, sans-serif; font-size: 12px; line-height: 1.6; text-align: justify;">
