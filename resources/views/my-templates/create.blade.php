...
@section('title', __('messages.create_new_template_title') . ' - ' . config('app.name'))
    ...
    <div class="profile-layout"
        ...
        <div class="container">
            <div class="form-container">
                <h2 class="h3 mb-4" style="color: var(--text-primary);">{{ __('messages.create_new_template_title') }}</h2>
                ...
                <form method="POST" action="{{ route('profile.my-templates.store', app()->getLocale()) }}" class="mt-4">
                    @csrf
                    <div class="row mb-4">
                        <div class="col-md-6">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" id="templateName" name="name" class="form-control modern-form-control" value="{{ old('name') }}" required>
                    </div>
                    ...
                    <button type="submit" class="btn btn-success-modern btn-modern mt-4">{{ __('messages.save_template_button') }}</button>
                </form>
            </div>
        </div>
    </div>
